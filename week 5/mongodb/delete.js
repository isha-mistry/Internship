...
async function main() {
     ...
     */
    const uri = "mongodb+srv://imistry200131:uelWuZnN9MZnAzHU@cluster0.taqbkzy.mongodb.net/?retryWrites=true&w=majority";
    ...
    try {
        ...
        await deleteListingByName(client, "Private room in London");
        ...
        await printIfListingExists(client, "Lovely Loft");
